<?php $__env->startSection("title", "Edit Charging Station"); ?>
...
<?php $__env->startSection("content"); ?>
    <section>
        ...
        <div>
            <form method="post" action="<?php echo e(route('chargingStation.update')); ?>">
                <?php echo csrf_field(); ?>
                <input type="hidden" id="charging-station-id" name="charging_station_id" value="<?php echo e($data['charging_station'][0]->cs_id); ?>" required/>
                <table class="table">
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" id="charging-station-name" name="charging_station_name" value="<?php echo e($data['charging_station'][0]->cs_name); ?>" required/>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" id="ward_number" name="ward_number" step="1" min="1" max="1" value="<?php echo e($data['charging_station'][0]->ward_number); ?>" required/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" id="ac_ports_fast" name="ac_ports_fast" step="1" min="0" value="<?php echo e($data['charging_station'][0]->ac_fast); ?>" required/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" id="dc_ports_fast" name="dc_ports_fast" step="1" min="0" value="<?php echo e($data['charging_station'][0]->dc_fast); ?>" required/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" id="ac_ports_regular" name="ac_ports_regular" step="1" min="0" value="<?php echo e($data['charging_station'][0]->ac_reg); ?>" required/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" id="dc_ports_regular" name="dc_ports_regular" step="1" min="0" value="<?php echo e($data['charging_station'][0]->dc_reg); ?>" required/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" id="nearest_restaurant" name="nearest_restaurant" min="0" value="<?php echo e($data['charging_station'][0]->restaurant); ?>" required/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" id="nearest_shopping_mall" name="nearest_shopping_mall" min="0" value="<?php echo e($data['charging_station'][0]->mall); ?>" required/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" id="nearest_cinema_hall" name="nearest_cinema_hall" min="0" value="<?php echo e($data['charging_station'][0]->cinema); ?>" required/>
    ...
    <script>
        ...
        for (let i = 0; i < province_option.length; i++) {
            if (province_option[i].value == <?php echo e($data['charging_station'][0]->province); ?>) {
        ...
        for (let i = 0; i < district_option.length; i++) {
            if (district_option[i].value == <?php echo e($data['charging_station'][0]->district); ?>) {
        ...
        for (let i = 0; i < metropolitan_option.length; i++) {
            if (metropolitan_option[i].value == <?php echo e($data['charging_station'][0]->metropolitan); ?>) {
...
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\EV project\EVCSRecommendation\resources\views/chargingStation/editChargingStation.blade.php ENDPATH**/ ?>